...
class EmpleadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empleado" do
    assert_difference('Empleado.count') do
      post empleados_url, params: { empleado: { apellido: @empleado.apellido, cargo: @empleado.cargo, nombre: @empleado.nombre } }
    end
  ...
  test "should update empleado" do
    patch empleado_url(@empleado), params: { empleado: { apellido: @empleado.apellido, cargo: @empleado.cargo, nombre: @empleado.nombre } }

...
class EstudiantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudiante" do
    assert_difference('Estudiante.count') do
      post estudiantes_url, params: { estudiante: { apellido_materno: @estudiante.apellido_materno, apellido_paterno: @estudiante.apellido_paterno, nombre: @estudiante.nombre } }
    end
  ...
  test "should update estudiante" do
    patch estudiante_url(@estudiante), params: { estudiante: { apellido_materno: @estudiante.apellido_materno, apellido_paterno: @estudiante.apellido_paterno, nombre: @estudiante.nombre } }

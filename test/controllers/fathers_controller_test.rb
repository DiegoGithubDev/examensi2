...
class FathersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create father" do
    assert_difference('Father.count') do
      post fathers_url, params: { father: { apellido: @father.apellido, celular: @father.celular, nombre: @father.nombre, tipo: @father.tipo } }
    end
  ...
  test "should update father" do
    patch father_url(@father), params: { father: { apellido: @father.apellido, celular: @father.celular, nombre: @father.nombre, tipo: @father.tipo } }

...
class VehiculosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vehiculo" do
    assert_difference('Vehiculo.count') do
      post vehiculos_url, params: { vehiculo: { color: @vehiculo.color, marca: @vehiculo.marca, modelo: @vehiculo.modelo, placa: @vehiculo.placa } }
    end
  ...
  test "should update vehiculo" do
    patch vehiculo_url(@vehiculo), params: { vehiculo: { color: @vehiculo.color, marca: @vehiculo.marca, modelo: @vehiculo.modelo, placa: @vehiculo.placa } }
